...
$apns->on(sent => sub { $message_struct = $_[1] });
...
diag length $message;
is substr($message, 0, 1), $message_struct->[0], 'message starts with null chr';
...
is substr($message, -45), $message_struct->[4], 'message';
